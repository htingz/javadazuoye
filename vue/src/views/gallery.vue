  ...
  <div class="gallery" style="padding: 0px">
    <div class="banner">
      ...
      <div class="container">
        <div class="header">
          <div class="logo">
            <a href="/index/1">Jim <span>Guide</span></a>
          </div>
          <div class="top-nav">
            <ul class="flexy-menu orange nav1">
              <li><a class="active"  href="/index/1">首页</a></li>
              <li><a href="" onclick="window.open('/fitness_list')">健身教练搜索</a></li><!--  -->
              <li><a href="" onclick="window.open('/query')">我的订单</a></li>
              <li><a href="" onclick="window.open('/evaluate')">我的点评</a></li>
              <li><a href="" onclick="window.open('/diary')">健身日记</a></li>
              <li><a href="" onclick="window.open('/plan')">健身计划</a></li>
              <li><a href="" onclick="window.open('/paid')">提交预定</a></li>
            </ul>
          </div>
...
.banner{
  background:url("../assets/image/banner.jpg") no-repeat 0px -279px;
